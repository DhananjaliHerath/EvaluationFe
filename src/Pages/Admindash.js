...
export default function Admindash() {
    ...
    const professions = [ "All User", "Profile",];
    ...
    <div>
      ...
      <div class="flex w-screen h-screen text-gray-200">
        ...
        <div class="flex flex-col w-56 border-r border-gray-800">
            ...
            <h1 class="text-lg font-medium item-center mt-8">Admin Dashboard</h1>
        ...
        <div class="flex flex-col flex-grow">
            <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
                <h1 class="text-lg font-medium item-center justify-center container">Admin Dashboard</h1>
